...
def similarity(left_input,right_input,my_conc):
    return my_dense(my_conc([left_input,right_input]))
...
my_similarity = similarity(left_output, right_output, my_conc)
...
malstm = Model([left_input, right_input], my_similarity)
