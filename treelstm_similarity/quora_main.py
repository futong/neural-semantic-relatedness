...
from treelstm.dataset import QuoraDataset
...
def main():
    ...
    logger.debug('==> quora vocabulary size : %d ' % vocab.size())

    # load SICK dataset splits
    train_file = os.path.join(args.data, 'quora_train.pth')
    if os.path.isfile(train_file):
        train_dataset = torch.load(train_file)
    else:
        train_dataset = QuoraDataset(train_dir, vocab, args.num_classes)
        # train_dataset = QuoraDataset(dev_dir, vocab, args.num_classes)
        torch.save(train_dataset, train_file)
    logger.debug('==> Size of train data   : %d ' % len(train_dataset))
    dev_file = os.path.join(args.data, 'Quora_dev.pth')
    ...
    test_file = os.path.join(args.data, 'Quora_test.pth')
    ...
    emb_file = os.path.join(args.data, 'quora_embed.pth')
